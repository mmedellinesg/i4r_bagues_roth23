 ...
 *xi:   areg z_identity i.region_military $controls if other_region_17_mili==0, cl(cluster) a(cluster)


 xi:   areg z_identity other_region_17_mili i.region_military $controls, cl(cluster) a(cluster)


 xi:   areg z_identity other_region_17_mili i.region_military $controls, cl(cluster) a(cluster)
  xi:   areg z_identity other_region_17_mili_HET4 other_region_17_mili predictedregionalism i.region_military $controls, cl(cluster) a(cluster)
  xi:   areg z_identity other_region_17_mili_HET3 other_region_17_mili nationalisticregion2 i.region_military $controls, cl(cluster) a(cluster)
...
esttab * using "$output/identity_regionofserviceFE.tex", replace cells(none) booktabs nonotes nomtitles /*nonum*/ compress alignment(c) nogap noobs nobaselevels label stats(`rowstats', labels(`rowlabels')) ///
